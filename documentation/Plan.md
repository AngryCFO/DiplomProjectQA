...
- [Чек-лист](Чек-лист_ДипломQA.xlsx) c отметками о пройденных и не пройденных тестах (`Чек-лист_ДипломQA.xlsx`)

- [Тест-кейсы](Тест-кейсы_ДипломQA.xlsx) для проверки приложения (`Тест-кейсы_ДипломQA.xlsx`)
